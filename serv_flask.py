...
def web_search():
    ...
    return df_search.to_html(table_id="tbl_search_results", render_links=True, index=False, justify="left")
...
def contents_from_crawler():
    ...
    return df_merged.to_html(table_id="tbl_search_results", render_links=True, index=False, justify="left")
...
def fc_tagging():
    ...
    return df_merged2.to_html(table_id="tbl_search_results", render_links=True, index=False, justify="left")
